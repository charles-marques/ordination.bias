...
def verificar_arquivo(arquivo_path):
    ...
    for line in arquivo:
        for ordem in ordenacoes:
            ...
            if ordem in line:
                caminho = str(arquivo_path).replace('/home/suporte/Documentos/source_projects_bkp/projet_','').split('/')
...
output_result = open('resources/resultados/links_com_ordenacoes_v4.txt','w')
# listar('/home/suporte/Documentos/source_projects')
